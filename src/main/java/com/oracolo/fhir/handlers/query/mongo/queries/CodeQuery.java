...
import com.oracolo.fhir.utils.querybuilder.QueryBuilder;
  ...
  public JsonObject mongoDbPipelineStageQuery(String paramName, String paramValue) {
    ...
    JsonObject builderCodeQuery = QueryBuilder.builder()
      ...
      .addNewOrElement(QueryBuilder.builder()
        .createRegexMatch("$code.text", paramValue, QueryBuilder.MongoDbRegexOptions.i))
      .addNewOrElement(QueryBuilder.builder()
        .createRegexMatch(QueryBuilder.builder()
            .createReduce("$code.coding", "", QueryBuilder
              .builder()
              .createConcat("$$value", "$$this.code", " ", "$$this.display", " ")),
          paramValue, QueryBuilder.MongoDbRegexOptions.i))
      .query();
...
////            ))
////        );
      return builderCodeQuery;
    } else {
      String system = paramValue.split("\\|")[0];
      String code = paramValue.split("\\|")[1];
      JsonObject builderSystemCode = QueryBuilder.builder()
        .createOrCondition()
        .addNewOrElement(QueryBuilder.builder()
          .createRegexMatch("$code.text", code, QueryBuilder.MongoDbRegexOptions.i))
        .addNewOrElement(QueryBuilder.builder()
          .createRegexMatch(QueryBuilder.builder()
              .createReduce("$code.coding", "", QueryBuilder
                .builder()
                .createConcat("$$value", "$$this.code", " ", "$$this.display", " ")),
            code, QueryBuilder.MongoDbRegexOptions.i))
        .addNewOrElement(QueryBuilder.builder()
          .createRegexMatch(QueryBuilder.builder()
              .createReduce("$code.coding", "", QueryBuilder.builder()
                .createConcat("$$value", "$$this.system")),
            system.equals("") ? null : system, QueryBuilder.MongoDbRegexOptions.i))
        .query();
      return builderSystemCode;
//      return new JsonObject()
//        .put("$or", new JsonArray()
//          .add(new JsonObject()
//            .put("$regexMatch", new JsonObject()
