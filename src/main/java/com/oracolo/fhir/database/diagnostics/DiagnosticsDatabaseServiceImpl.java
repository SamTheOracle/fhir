...
public class DiagnosticsDatabaseServiceImpl implements DiagnosticsDatabaseService {
  private final static String DELETE_COLLECTION = "deleted_resources";
  private final MongoClient mongoClient;

  public DiagnosticsDatabaseServiceImpl(MongoClient mongoClient) {
    this.mongoClient = mongoClient;
  }


  @Override
  public DiagnosticsDatabaseService findDeleteDocument(String id, Handler<AsyncResult<JsonObject>> handler) {
  ...
  @Override
  public DiagnosticsDatabaseService insertDocuments(JsonArray deletedFhirResources, Handler<AsyncResult<Void>> handler) {
  ...
  @Override
  public DiagnosticsDatabaseService deleteAllResourceById(String collectionName, String resourceId, Handler<AsyncResult<Void>> handler) {
